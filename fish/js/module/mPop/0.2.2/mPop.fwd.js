    ...
    */
    ...
    winBox.prototype = {
        init: function (bool) {  //初始化弹层
            ...
            if (fish.one(".outBag", document.body).length == 0) {
                outBag.style.zIndex = 1000;
            } else {
                outBag.style.zIndex = (fish.one(".outBag", document.body)[0].style.zIndex) * 1 + 10;
            }
...
//                    this.hide(bgIframe);
                ...
                fish.dom(document.body).appendChild(bgBag);
                ...
                if (fish.one(".outBag", document.body).length == 0) {
                    ...
                    bgBag.style.zIndex = (fish.one(".outBag", document.body)[0].style.zIndex) * 1 + 1;
                }
            ...
            fish.all(document.body).html("top", outBag);
