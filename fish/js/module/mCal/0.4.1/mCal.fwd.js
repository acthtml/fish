(function () {
    ...
    function addMonth(id, date) {
        ...
        for (var i = 1; i <= 42; i++) {
            ...
            if ((nowday != 7 && i <= nowday) || i > newTdNum) {
                ...
                span.innerHTML = " ";
                fish.all(span).addClass("spanOver");
                ...
                span.onmouseover = function () {
                    if (this.getAttribute(IS_SPECIAL_DAY) == "true") {
                        fish.all(this).addClass(HOVER_CLASS);
                    } else {
                        fish.all(this).addClass("spanHover");
                    }

                };
                span.onmouseout = function () {
                    if (this.getAttribute(IS_SPECIAL_DAY) == "true") {
                        fish.all(this).removeClass(HOVER_CLASS);
                    } else {
                        fish.all(this).removeClass("spanHover");
                    }
                };
                ...
                if (now_Year == ol_Year && now_Month == ol_Month && now_Day == (nowPrintDay)) {
                    span.innerHTML = "今天";
                    fish.all(span).addClass("spanDay");
                    span.setAttribute(DAY, nowPrintDay);
                    span.setAttribute(IS_SPECIAL_DAY, "true");
                }
                //绑定明天样式
                ...
                if (fish.parseTime(ol_Year + "-" + (ol_Month + 1) + "-" + nowPrintDay) == fish.parseTime(new Date(), { days: 1 })) {
                    span.innerHTML = "明天";
                    fish.all(span).addClass("spanTomo");
                    span.setAttribute(IS_SPECIAL_DAY, "true");
                    span.setAttribute(DAY, nowPrintDay);
                }
                //绑定选择过的日期
                if (date._lastTime != null) {
                    ...
                    if (isShowSE(clickDate, printDate, date)) {
                        fish.all(span).addClass("clickDate");
                        span.onmouseout = function () {};
                    }
                }
    ...
    */
    ...
    function _getSpecialDate() {
        var specialDate = {
            specialDate: [
                {date: "2013-01-01",name: "元旦"},
                {date: "2013-02-09",name: "除夕"},
                {date: "2013-02-10",name: "春节"},
                {date: "2013-02-24",name: "元宵"},
                {date: "2013-04-04",name: "清明"},
                {date: "2013-05-01",name: "5.1"},
                {date: "2013-06-01",name: "6.1"},
                {date: "2013-06-12",name: "端午"},
                {date: "2013-08-13",name: "七夕"},
                {date: "2013-09-19",name: "中秋"},
                {date: "2013-10-01",name: "国庆"},
                {date: "2013-12-25",name: "圣诞"},
				{date: "2012-04-04",name: "清明"},
                {date: "2012-05-01",name: "5.1"},
                {date: "2012-06-01",name: "6.1"},
				{date: "2012-06-23",name: "端午"},
                {date: "2012-08-23",name: "七夕"},
				{date: "2012-09-30",name: "中秋"},
				{date: "2012-10-01",name: "国庆"},
                {date: "2012-12-25",name: "圣诞"}
			]
