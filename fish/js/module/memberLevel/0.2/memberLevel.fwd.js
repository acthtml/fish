    ...
    function main(paramInput){
        ...
        param.actMemberElem = function() {
             ...
             if (oneState.level == "1") {
                 ...
                 that.addClass(remo_class);
                 that.html("top", '<div class="level_Id level_box leve_pop" style="display:none;margin-left:0px;margin-top:25px;"><span class="inner_pic pic_lef"></span> <div class="pic_rig"><span class="my_lev my_level">我的等级：</span><div class="tg_groupTop group_today"><div class="group_center_main group_center" style="overflow: hidden; position: relative;">' +
                 ...
                 for (var n = 0; n < oneState.spec.length; n++) {
					  if(fish.trim(oneState.spec[n]).length<=0){
						continue;
					  }
