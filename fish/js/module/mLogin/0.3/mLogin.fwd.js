                           ...
                           <table cellspacing="0" cellpadding="0" border="0" class="login_content">\
                               <tbody>\
                                   ...
                                   <tr>\
                                       ...
                                       <tr class="signin none">\
                                           <td colspan=2>\
                                               <div class="boxtr clearfix">\
                                                    <span class="l2_text">还不是同程会员？\
                                                    </span><a target="_blank" href="http://passport.17u.cn/register/index/" title="注册">免费注册</a>\
                                               </div>\
                                           </td>\
                                       </tr>\
                                   </tr>\
        ...
        _getPassCallBack : function(data){
            ...
            if(data && data == 1){
                ...
                if (data == "3") {
                    ...
                    this._showVerifyPassTips("对不起，您的手机号还未注册，立即<a target='_blank' href='http://passport.17u.cn/register/index/'>注册</a>");
                }
                else{
