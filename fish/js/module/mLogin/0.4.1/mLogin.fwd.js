...
//            fish.one( that.loginElem).css("height:" + that.__loginContentElem.height() + "px");
        ...
        open:function(){
            ...
            var that = this;
            if(this.showSignupFirst){
            	fish.mPop({content:this.freeSignupElem,afterClose:function(){that.showing = false}});
            }else{
            	fish.mPop({content:this.loginElem,afterClose:function(){that.showing = false}});
            }
        },
        //显示注册弹框
        ...
        showPassBox : function(){
        	...
        	this.showing = true;
        	var that = this;
            fish.mPop({content:this.passElem,afterClose:function(){that.showing = false}});
        },
        //显示重置密码框
        showResetBox : function(){
        	...
        	this.showing = true;
        	var that = this;
            fish.mPop({content:this.resetPassElem,afterClose:function(){that.showing = false}});
        },
        //开始倒计时
