(function () {
    ...
    function mPaging(param) {
        ...
        this.startWithAjax = this.startWithAjax != null ? this.startWithAjax : true;
    ...
    mPaging.prototype = {
        ...
        build: function (_size) {
            ...
            if (size > 6) {
                if (_this.CURRENT_PAGE == 1 || _this.CURRENT_PAGE > size - 3) {
                    pageSatrt = 1;
                    pageEnd = 3;
                } else if (_this.CURRENT_PAGE == size - 3) {
                    pageSatrt = _this.CURRENT_PAGE - 2;
                    pageEnd = _this.CURRENT_PAGE;
                } else {
                    pageSatrt = _this.CURRENT_PAGE - 1;
                    pageEnd = _this.CURRENT_PAGE + 1;
                }
